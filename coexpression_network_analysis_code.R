...
#Code to calculate module eigengenes and plot them as in figure 4A and figure S2F------------
...
#Eigengene heatmap as in figure S2f 
...
#Code for plotting module hub genes on single cell data as in figure S3-------
...
p
dev.off()
#Code for TFBS anaylsis and plotting results as in figure S2G-------
